...
minishell.c env_utils.c getpaths.c cd.c echo.c env.c exit.c export.c pwd.c unset.c \
pipe.c redir.c print.c tree.c utils.c find.c advlst.c destroy.c extract.c new_data.c \
-o minishell
